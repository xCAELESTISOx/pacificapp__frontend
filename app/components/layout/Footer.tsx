    ...
    <footer className="bg-gray-100 mt-auto py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Pacificapp</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/stress" className="text-sm text-gray-600 hover:text-primary-600">
                  Стресс
                </Link>
              </li>
              <li>
                <Link href="/sleep" className="text-sm text-gray-600 hover:text-primary-600">
                  Сон
                </Link>
              </li>
              <li>
                <Link href="/work" className="text-sm text-gray-600 hover:text-primary-600">
                  Рабочая активность
                </Link>
              </li>
              <li>
                <Link href="/recommendations" className="text-sm text-gray-600 hover:text-primary-600">
                  Рекомендации
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-600">
                <span className="font-medium">Email:</span> info@pacificapp.ru
              </li>
              <li className="text-sm text-gray-600">
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0">
            © {currentYear} Pacificapp. Все права защищены.
          </p>
